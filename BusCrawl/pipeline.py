...
class MongoPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        data = dict(item)
        now = dte.now()
        if data["crawl_source"] in ["cqky", "zjgsm", "wxsz", "tongcheng", "cbd", "jsky", "fangbian", "jsdlky", "baba", "tzky", "ctrip", "changtu", "scqcp", "bus365",'szky', "xyjt", "gdsw",'dgky', 'zhw','wmcx','lvtu100','glcx']:
