...
class HnSpider(SpiderBase):
    ...
    def start_requests(self):
        ...
        #         for z in x.get('ZD'):
        #             if y != z:
        #                 # print y.get('Name'), z.get('Name'),y.get('DM'), x.get('City')
        #                 url = 'http://www.hn96520.com/placeorder.aspx?start={0}&global={1}&end={2}&date=--{3}'.format(y.get('Name'), y.get('DM'), z.get('Name'), x.get('City'))
        #                 urls.append(url)
        # for i in xrange(7):
